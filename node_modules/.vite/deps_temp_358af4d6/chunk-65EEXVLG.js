...
function useFocusWithin({
  ...
  const [focused, _setFocused] = (0, import_react54.useState)(false);
...
function useDelayUnmount(open, durationMs) {
  const [isMounted, setIsMounted] = React12.useState(open);
  if (open && !isMounted) {
    setIsMounted(true);
  }
  React12.useEffect(() => {
...
function useTransitionStatus(context, props) {
  ...
  const [status, setStatus] = React12.useState("unmounted");
...
function useTransitionStyles(context, props) {
  ...
  const closeDuration = (isNumberDuration ? duration : duration.close) || 0;
  const [styles, setStyles] = React12.useState(() => ({
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-65EEXVLG.js.map
