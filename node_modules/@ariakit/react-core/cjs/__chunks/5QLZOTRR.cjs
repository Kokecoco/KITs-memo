...
var _7LTYTJQAcjs = require('./7LTYTJQA.cjs');


var _WOYO6QOEcjs = require('./WOYO6QOE.cjs');
...
var useCheckbox = _M5IWBORBcjs.createHook.call(void 0, 
  function useCheckbox2(_a) {
    ...
    const context = _7LTYTJQAcjs.useCheckboxContext.call(void 0, );
    store = store || context;
    const [_checked, setChecked] = _react.useState.call(void 0, defaultChecked != null ? defaultChecked : false);
    const checked = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _WOYO6QOEcjs.CheckboxCheckedContext.Provider, { value: isChecked, children: element }),
      [isChecked]
    );
    ...
    props = _RGJOOXFUcjs.useCommand.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { clickOnEnter: !nativeCheckbox }, props));
...
var Checkbox = _M5IWBORBcjs.forwardRef.call(void 0, function Checkbox2(props) {
