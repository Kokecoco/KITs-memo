...
var _MA4SJD6Ecjs = require('./MA4SJD6E.cjs');
...
var _PXR5PBE2cjs = require('./PXR5PBE2.cjs');
...
var TagName = "div";
var useMenubar = _M5IWBORBcjs.createHook.call(void 0, 
  function useMenubar2(_a) {
    ...
    const context = _O3ON5SWHcjs.useMenubarProviderContext.call(void 0, );
    storeProp = storeProp || context;
    const store = _MA4SJD6Ecjs.useMenubarStore.call(void 0, {
      store: storeProp,
      orientation: orientationProp,
      virtualFocus,
      focusLoop,
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _O3ON5SWHcjs.MenubarScopedContextProvider, { value: store, children: element }),
      [store]
    );
    if (composite) {
    ...
    props = _PXR5PBE2cjs.useComposite.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store, composite }, props));
    return props;
  }
);
var Menubar = _M5IWBORBcjs.forwardRef.call(void 0, function Menubar2(props) {
