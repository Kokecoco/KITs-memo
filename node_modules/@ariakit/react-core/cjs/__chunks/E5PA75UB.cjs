...
var _RRCMCI3Icjs = require('./RRCMCI3I.cjs');


var _RGJOOXFUcjs = require('./RGJOOXFU.cjs');
...
function findNextPageItemId(element, store, next, pageUp = false) {
  ...
  for (let i = 0; i < renderedItems.length; i += 1) {
    ...
    const itemElement = (_a = _BV5PE6PZcjs.getEnabledItem.call(void 0, store, id)) == null ? void 0 : _a.element;
...
function targetIsAnotherItem(event, store) {
  ...
  return _BV5PE6PZcjs.isItem.call(void 0, store, event.target);
}
var useCompositeItem = _M5IWBORBcjs.createHook.call(void 0, 
  function useCompositeItem2(_a) {
    ...
    const row = _react.useContext.call(void 0, _3MQN464Lcjs.CompositeRowContext);
    const rowId = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const onFocus = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
      ...
      const fromComposite = event.relatedTarget === baseElement2 || _BV5PE6PZcjs.isItem.call(void 0, store, event.relatedTarget);
      if (fromComposite) {
        _BV5PE6PZcjs.focusSilently.call(void 0, baseElement2);
      } else {
        baseElement2.focus();
      }
    });
    const onBlurCaptureProp = props.onBlurCapture;
    const onBlurCapture = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
    ...
    const preventScrollOnKeyDownProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, preventScrollOnKeyDown);
    const moveOnKeyPressProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, moveOnKeyPress);
    ...
    const baseElement = _DMH7HONVcjs.useStoreState.call(void 0, 
      store,
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _3MQN464Lcjs.CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    const isActiveItem = _DMH7HONVcjs.useStoreState.call(void 0, 
      store,
      (state) => !!state && state.activeId === id
    );
    const ariaSetSize = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _RGJOOXFUcjs.useCommand.call(void 0, props);
    props = _RRCMCI3Icjs.useCollectionItem.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
      shouldRegisterItem: id ? props.shouldRegisterItem : false
    }));
    return _misc.removeUndefinedValues.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), {
      "aria-setsize": ariaSetSize,
      "aria-posinset": ariaPosInSet
    }));
  }
);
var CompositeItem = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function CompositeItem2(props) {
