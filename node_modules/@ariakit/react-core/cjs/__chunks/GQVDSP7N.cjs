...
var _X5YEYHCOcjs = require('./X5YEYHCO.cjs');
...
var TagName = "button";
var useDialogDismiss = _M5IWBORBcjs.createHook.call(void 0, 
  function useDialogDismiss2(_a) {
    var _b = _a, { store } = _b, props = _3IVNQNIVcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _HHTQYHYLcjs.useDialogScopedContext.call(void 0, );
    store = store || context;
...
var DialogDismiss = _M5IWBORBcjs.forwardRef.call(void 0, function DialogDismiss2(props) {
