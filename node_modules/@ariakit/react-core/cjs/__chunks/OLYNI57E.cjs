...
var usePopover = _M5IWBORBcjs.createHook.call(void 0, 
  function usePopover2(_a) {
    ...
    const getAnchorRectProp = _WT6AUJWVcjs.useEvent.call(void 0, getAnchorRect);
    const updatePositionProp = _WT6AUJWVcjs.useEvent.call(void 0, updatePosition);
    ...
    props = _MYUTK2J2cjs.useDialog.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store,
      modal,
      portal,
      preserveTabOrder,
...
var Popover = _MYUTK2J2cjs.createDialogComponent.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function Popover2(props) {
    const htmlProps = usePopover(props);
    return _M5IWBORBcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _AMARRBCFcjs.usePopoverProviderContext
);
