...
var _5KP7SROCcjs = require('./5KP7SROC.cjs');
...
var _67WF5W26cjs = require('./67WF5W26.cjs');


var _TJR4NN4Vcjs = require('./TJR4NN4V.cjs');


var _PG3ORY54cjs = require('./PG3ORY54.cjs');
...
var _4S6ECZOGcjs = require('./4S6ECZOG.cjs');


var _FAFAXYUEcjs = require('./FAFAXYUE.cjs');


var _QMBTS2OCcjs = require('./QMBTS2OC.cjs');
...
var _46DIVJOTcjs = require('./46DIVJOT.cjs');
...
var _SDBASOGFcjs = require('./SDBASOGF.cjs');
...
var useDialog = _M5IWBORBcjs.createHook.call(void 0, function useDialog2(_a) {
  var _b = _a, {
    store: storeProp,
    open: openProp,
    onClose,
  ...
  const store = _SDBASOGFcjs.useDialogStore.call(void 0, {
  ...
  const { portalRef, domReady } = _WT6AUJWVcjs.usePortalRef.call(void 0, portal, props.portalRef);
  ...
  const hidden = _VRPZ4HD5cjs.isHidden.call(void 0, mounted, props.hidden, props.alwaysVisible);
  _67WF5W26cjs.usePreventBodyScroll.call(void 0, contentElement, id, preventBodyScroll && !hidden);
  _PG3ORY54cjs.useHideOnInteractOutside.call(void 0, store, hideOnInteractOutside, domReady);
  const { wrapElement, nestedDialogs } = _TJR4NN4Vcjs.useNestedDialogs.call(void 0, store);
  props = _WT6AUJWVcjs.useWrapElement.call(void 0, props, wrapElement, [wrapElement]);
  ...
  const getPersistentElementsProp = _WT6AUJWVcjs.useEvent.call(void 0, getPersistentElements);
  _WT6AUJWVcjs.useSafeLayoutEffect.call(void 0, () => {
    if (!id) return;
    if (!canTakeTreeSnapshot) return;
    const { disclosureElement } = store.getState();
  ...
  const autoFocusOnShowProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, autoFocusOnShow);
  ...
  const autoFocusOnHideProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, autoFocusOnHide);
  ...
  const hideOnEscapeProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, hideOnEscape);
  _react.useEffect.call(void 0, () => {
    if (!domReady) return;
    if (!mounted) return;
  ...
  props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _HHTQYHYLcjs.DialogScopedContextProvider, { value: store, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _HHTQYHYLcjs.DialogHeadingContext.Provider, { value: setHeadingId, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _HHTQYHYLcjs.DialogDescriptionContext.Provider, { value: setDescriptionId, children: element }) }) }),
    [store]
  );
  ...
  props = _4S6ECZOGcjs.useFocusableContainer.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), {
    autoFocusOnShow: autoFocusEnabled
  }));
  props = _VRPZ4HD5cjs.useDisclosureContent.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props));
  props = _46DIVJOTcjs.useFocusable.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), { focusable }));
  props = _QMBTS2OCcjs.usePortal.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { portal }, props), { portalRef, preserveTabOrder }));
  return props;
});
function createDialogComponent(Component, useProviderContext = _HHTQYHYLcjs.useDialogProviderContext) {
  return _M5IWBORBcjs.forwardRef.call(void 0, function DialogComponent(props) {
    const context = useProviderContext();
    const store = props.store || context;
    const mounted = _DMH7HONVcjs.useStoreState.call(void 0, 
      store,
...
var Dialog = createDialogComponent(
  _M5IWBORBcjs.forwardRef.call(void 0, function Dialog2(props) {
    const htmlProps = useDialog(props);
    return _M5IWBORBcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _HHTQYHYLcjs.useDialogProviderContext
);
