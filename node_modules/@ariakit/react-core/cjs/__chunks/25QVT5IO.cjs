...
var _3HGFVGHBcjs = require('./3HGFVGHB.cjs');


var _OLYNI57Ecjs = require('./OLYNI57E.cjs');


var _MYUTK2J2cjs = require('./MYUTK2J2.cjs');
...
var useHovercard = _M5IWBORBcjs.createHook.call(void 0, 
  function useHovercard2(_a) {
    ...
    const hideOnHoverOutsideProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, hideOnHoverOutside);
    const mayDisablePointerEvents = !!disablePointerEventsOnApproach;
    const disablePointerEventsProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, 
      disablePointerEventsOnApproach
    );
    ...
    _react.useEffect.call(void 0, () => {
      ...
      const onMouseMove = (event) => {
        ...
        if (isMovingOnHovercard(target, element, anchor, nestedHovercards)) {
          enterPointRef.current = target && anchor && _dom.contains.call(void 0, anchor, target) ? _3HGFVGHBcjs.getEventPoint.call(void 0, event) : null;
        ...
        if (enterPoint) {
          const currentPoint = _3HGFVGHBcjs.getEventPoint.call(void 0, event);
          const polygon = _3HGFVGHBcjs.getElementPolygon.call(void 0, element, enterPoint);
          if (_3HGFVGHBcjs.isPointInPolygon.call(void 0, currentPoint, polygon)) {
    ...
    _react.useEffect.call(void 0, () => {
      ...
      const disableEvent = (event) => {
        ...
        const polygon = _3HGFVGHBcjs.getElementPolygon.call(void 0, element, enterPoint);
        if (_3HGFVGHBcjs.isPointInPolygon.call(void 0, _3HGFVGHBcjs.getEventPoint.call(void 0, event), polygon)) {
          if (!disablePointerEventsProp(event)) return;
          event.preventDefault();
          event.stopPropagation();
        }
    ...
    const openRef = _WT6AUJWVcjs.useLiveRef.call(void 0, open);
    _react.useEffect.call(void 0, () => {
      if (!domReady) return;
      return () => {
        if (!openRef.current) {
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ZBR3CZBXcjs.HovercardScopedContextProvider, { value: store, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, NestedHovercardContext.Provider, { value: registerNestedHovercard, children: element }) }),
    ...
    props = useAutoFocusOnHide(_3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props));
    const autoFocusOnShow = store.useState(
      (state) => modal || state.autoFocusOnShow
    );
    props = _OLYNI57Ecjs.usePopover.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store,
      modal,
      portal,
      autoFocusOnShow
...
var Hovercard = _MYUTK2J2cjs.createDialogComponent.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function Hovercard2(props) {
    const htmlProps = useHovercard(props);
    return _M5IWBORBcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _ZBR3CZBXcjs.useHovercardProviderContext
);
