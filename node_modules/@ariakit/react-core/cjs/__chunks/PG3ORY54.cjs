...
function useEventOutside({
  ...
  const callListener = _WT6AUJWVcjs.useEvent.call(void 0, listener);
  const open = _DMH7HONVcjs.useStoreState.call(void 0, store, "open");
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onEvent = (event) => {
      ...
      if (_46DIVJOTcjs.isSafariFocusAncestor.call(void 0, target)) return;
      callListener(event);
    };
