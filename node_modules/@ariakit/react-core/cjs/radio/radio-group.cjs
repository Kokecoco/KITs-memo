...
var _Y27X3JNFcjs = require('../__chunks/Y27X3JNF.cjs');
...
var TagName = "div";
var useRadioGroup = _M5IWBORBcjs.createHook.call(void 0, 
  function useRadioGroup2(_a) {
    var _b = _a, { store } = _b, props = _3IVNQNIVcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _Y27X3JNFcjs.useRadioProviderContext.call(void 0, );
    store = store || context;
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _Y27X3JNFcjs.RadioScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var RadioGroup = _M5IWBORBcjs.forwardRef.call(void 0, function RadioGroup2(props) {
