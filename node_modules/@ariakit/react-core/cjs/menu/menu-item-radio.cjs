...
var _QAZKJ363cjs = require('../__chunks/QAZKJ363.cjs');
require('../__chunks/Y27X3JNF.cjs');
...
var useMenuItemRadio = _M5IWBORBcjs.createHook.call(void 0, 
  function useMenuItemRadio2(_a) {
    ...
    const defaultChecked = _WT6AUJWVcjs.useInitialValue.call(void 0, props.defaultChecked);
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _TTVWSMCCcjs.MenuItemCheckedContext.Provider, { value: !!isChecked, children: element }),
      [isChecked]
    );
    props = _3IVNQNIVcjs.__spreadValues.call(void 0, {
      role: "menuitemradio"
    }, props);
    props = _QAZKJ363cjs.useRadio.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      name,
      value,
      checked: isChecked,
      onChange(event) {
...
var MenuItemRadio = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function MenuItemRadio2(props) {
