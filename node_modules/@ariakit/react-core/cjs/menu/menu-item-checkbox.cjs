...
var _5QLZOTRRcjs = require('../__chunks/5QLZOTRR.cjs');
require('../__chunks/7LTYTJQA.cjs');


var _HEJFPAL3cjs = require('../__chunks/HEJFPAL3.cjs');


var _4CMPAQHUcjs = require('../__chunks/4CMPAQHU.cjs');


var _TTVWSMCCcjs = require('../__chunks/TTVWSMCC.cjs');
require('../__chunks/O3ON5SWH.cjs');
require('../__chunks/I5DDKOOP.cjs');
require('../__chunks/WOYO6QOE.cjs');
require('../__chunks/E5PA75UB.cjs');
...
var useMenuItemCheckbox = _M5IWBORBcjs.createHook.call(void 0, 
  function useMenuItemCheckbox2(_a) {
    ...
    const context = _TTVWSMCCcjs.useMenuScopedContext.call(void 0, );
    store = store || context;
    _misc.invariant.call(void 0, 
      store,
      process.env.NODE_ENV !== "production" && "MenuItemCheckbox must be wrapped in a MenuList or Menu component"
    );
    const defaultChecked = _WT6AUJWVcjs.useInitialValue.call(void 0, defaultCheckedProp);
    ...
    const checkboxStore = _HEJFPAL3cjs.useCheckboxStore.call(void 0, {
    ...
    props = _5QLZOTRRcjs.useCheckbox.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store: checkboxStore,
      name,
      value,
      checked
    }, props));
    props = _4CMPAQHUcjs.useMenuItem.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store, hideOnClick }, props));
    return props;
  }
);
var MenuItemCheckbox = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function MenuItemCheckbox2(props) {
