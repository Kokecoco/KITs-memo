...
var TagName = "button";
var useFormSubmit = _M5IWBORBcjs.createHook.call(void 0, 
  function useFormSubmit2(_a) {
    var _b = _a, { store, accessibleWhenDisabled = true } = _b, props = _3IVNQNIVcjs.__objRest.call(void 0, _b, ["store", "accessibleWhenDisabled"]);
    ...
    props = _X5YEYHCOcjs.useButton.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), { accessibleWhenDisabled }));
    return props;
  }
);
var FormSubmit = _M5IWBORBcjs.forwardRef.call(void 0, function FormSubmit2(props) {
