...
var _X5YEYHCOcjs = require('../__chunks/X5YEYHCO.cjs');
...
var useFormPush = _M5IWBORBcjs.createHook.call(void 0, 
  function useFormPush2(_a) {
    ...
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, item), { type: "button", name });
        if (getItemProp) {
    ...
    props = _X5YEYHCOcjs.useButton.call(void 0, props);
    props = _RRCMCI3Icjs.useCollectionItem.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props), { getItem }));
    return props;
  }
);
var FormPush = _M5IWBORBcjs.forwardRef.call(void 0, function FormPush2(props) {
