...
var _RMSWSIPTcjs = require('../__chunks/RMSWSIPT.cjs');


var _PXR5PBE2cjs = require('../__chunks/PXR5PBE2.cjs');
...
var useCombobox = _M5IWBORBcjs.createHook.call(void 0, 
  function useCombobox2(_a) {
    ...
    const [valueUpdated, forceValueUpdate] = _WT6AUJWVcjs.useForceUpdate.call(void 0, );
    ...
    _WT6AUJWVcjs.useUpdateLayoutEffect.call(void 0, () => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    ...
    const getAutoSelectIdProp = _WT6AUJWVcjs.useEvent.call(void 0, getAutoSelectId);
    ...
    _WT6AUJWVcjs.useUpdateEffect.call(void 0, () => {
      var _a2, _b2;
    ...
    const showOnChangeProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, showOnChange != null ? showOnChange : canShow);
    const setValueOnChangeProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, 
    ...
    const onCompositionEnd = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = true;
    ...
    const blurActiveItemOnClickProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, 
      blurActiveItemOnClick != null ? blurActiveItemOnClick : () => !!(store == null ? void 0 : store.getState().includesBaseElement)
    );
    const setValueOnClickProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, setValueOnClick);
    const showOnClickProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, showOnClick != null ? showOnClick : canShow);
    const onMouseDown = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
    ...
    const showOnKeyPressProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, showOnKeyPress != null ? showOnKeyPress : canShow);
    ...
    const onBlur = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = false;
    ...
    props = _PXR5PBE2cjs.useComposite.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store,
      focusable
    }, props), {
...
var Combobox = _M5IWBORBcjs.forwardRef.call(void 0, function Combobox2(props) {
