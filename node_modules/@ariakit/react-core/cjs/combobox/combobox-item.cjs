...
var _I5DDKOOPcjs = require('../__chunks/I5DDKOOP.cjs');
...
var _E5PA75UBcjs = require('../__chunks/E5PA75UB.cjs');
require('../__chunks/RRCMCI3I.cjs');
require('../__chunks/RGJOOXFU.cjs');
...
var useComboboxItem = _M5IWBORBcjs.createHook.call(void 0, 
  function useComboboxItem2(_a) {
    ...
    var _a2;
    const context = _F4DU6MSGcjs.useComboboxScopedContext.call(void 0, );
    store = store || context;
    ...
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, item), { value });
        if (getItemProp) {
    ...
    const setValueOnClickProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, setValueOnClick);
    const selectValueOnClickProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, selectValueOnClick);
    const resetValueOnSelectProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, 
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _F4DU6MSGcjs.ComboboxItemValueContext.Provider, { value, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _F4DU6MSGcjs.ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
    const popupRole = _react.useContext.call(void 0, _F4DU6MSGcjs.ComboboxListRoleContext);
    ...
    props = _E5PA75UBcjs.useCompositeItem.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
    ...
    props = _I5DDKOOPcjs.useCompositeHover.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store, focusOnHover }, props));
    return props;
  }
);
var ComboboxItem = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function ComboboxItem2(props) {
