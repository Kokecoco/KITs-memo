...
var useSelectItem = _M5IWBORBcjs.createHook.call(void 0, 
  function useSelectItem2(_a) {
    ...
    var _a2;
    const context = _RBHGB7EBcjs.useSelectScopedContext.call(void 0, );
    store = store || context;
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _RBHGB7EBcjs.SelectItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }),
      [selected]
    );
    ...
    props = _E5PA75UBcjs.useCompositeItem.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store,
      getItem,
      preventScrollOnKeyDown
    }, props));
    const focusOnHoverProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, focusOnHover);
...
var SelectItem = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function SelectItem2(props) {
