...
var useTooltipAnchor = _M5IWBORBcjs.createHook.call(void 0, 
  function useTooltipAnchor2(_a) {
    ...
    const onMouseEnter = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
      onMouseEnterProp == null ? void 0 : onMouseEnterProp(event);
      canShowOnHoverRef.current = true;
    });
    const onFocusVisibleProp = props.onFocusVisible;
    const onFocusVisible = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
    ...
    props = _O5MREIJ3cjs.useHovercardAnchor.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      store,
      showOnHover(event) {
...
var TooltipAnchor = _M5IWBORBcjs.forwardRef.call(void 0, function TooltipAnchor2(props) {
