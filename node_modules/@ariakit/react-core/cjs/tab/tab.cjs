...
var TagName = "button";
var useTab = _M5IWBORBcjs.createHook.call(void 0, function useTab2(_a) {
  var _b = _a, {
    store,
    getItem: getItemProp
  ...
  var _a2;
  const context = _PSYRVXCOcjs.useTabScopedContext.call(void 0, );
  store = store || context;
  _misc.invariant.call(void 0, 
    store,
    process.env.NODE_ENV !== "production" && "Tab must be wrapped in a TabList component."
  );
  const defaultId = _WT6AUJWVcjs.useId.call(void 0, );
  const id = props.id || defaultId;
  const dimmed = _misc.disabledFromProps.call(void 0, props);
  const getItem = _react.useCallback.call(void 0, 
    (item) => {
      const nextItem = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, item), { dimmed });
      if (getItemProp) {
  ...
  const isWithinVirtualFocusComposite = _DMH7HONVcjs.useStoreState.call(void 0, 
  ...
  if (store.composite) {
    ...
    props = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props), {
      render: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        _E5PA75UBcjs.CompositeItem,
        _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, defaultProps), {
          render: store.combobox && store.composite !== store.combobox ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _E5PA75UBcjs.CompositeItem, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, defaultProps), { store: store.combobox })) : defaultProps.render
        })
      )
    });
  }
...
var Tab = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function Tab2(props) {
